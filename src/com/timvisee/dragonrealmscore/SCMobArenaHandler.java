...
public class SCMobArenaHandler extends DRCPluginHandler {
	...
	public void hook() {
    	...
    	if(!Bukkit.getServer().getPluginManager().isPluginEnabled(PLUGIN_NAME)) {
    		System.out.println("Disabling MobArena usage, plugin not found.");
    		return;
    	}
    	...
    	try {
	        ...
	        if (plugin == null) {
	        	System.out.println("Unable to hook into MobArena, plugin not found!");
	            return;
	        }
	        
	        // Hooked into MobArena, show a status message
	        this.ma = new MobArenaHandler();
	        System.out.println("Hooked into MobArena!");
	        return;
	        
    	} catch(NoClassDefFoundError ex) {
    		// Unable to hook into MobArena, show warning/error message.
    		System.out.println("Error while hooking into MobArena!");
    		return;
    	} catch(Exception ex) {
    		// Unable to hook into MobArena, show warning/error message.
    		System.out.println("Error while hooking into MobArena!");
	...
	public void unhook() {
        // Unhook MobArena
        this.ma = null;
        System.out.println("Unhooked MobArena!");
	}
