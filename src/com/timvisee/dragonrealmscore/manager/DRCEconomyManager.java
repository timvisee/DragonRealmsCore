...
public class DRCEconomyManager {
	
	private DRCEconomyManagerEconomySystemType economyType = DRCEconomyManagerEconomySystemType.NONE;
	private Server s;
	 ...
	 */
	public DRCEconomyManager(Server s, String logPrefix) {
		this.s = s;
	 ...
	 */
	public DRCEconomyManagerEconomySystemType getUsedEconomySystemType() {
	...
	public boolean isEnabled() {
		return !economyType.equals(DRCEconomyManagerEconomySystemType.NONE);
	}
	...
	public DRCEconomyManagerEconomySystemType setUp() {
		// Define the plugin manager
		final PluginManager pm = this.s.getPluginManager();
		
		// Reset used economy system type
		economyType = DRCEconomyManagerEconomySystemType.NONE;
		...
		if(simpleEconomy != null) {
			...
			economyType = DRCEconomyManagerEconomySystemType.SIMPLE_ECONOMY;
		    System.out.println("[" + logPrefix + "] Hooked into Simple Economy!");
		    return DRCEconomyManagerEconomySystemType.SIMPLE_ECONOMY;
		}
	    ...
	    if(bose != null) {
			...
			economyType = DRCEconomyManagerEconomySystemType.BOSECONOMY;
		    System.out.println("[" + logPrefix + "] Hooked into BOSEconomy!");
		    return DRCEconomyManagerEconomySystemType.BOSECONOMY;
	    }
		...
		if (vaultPlugin != null && vaultPlugin.isEnabled()) {
	        ...
	        if (economyProvider != null) {
	            ...
	            if(vaultEconomy.isEnabled()) {
	            	economyType = DRCEconomyManagerEconomySystemType.VAULT;
	            	System.out.println("[" + logPrefix + "] Hooked into Vault Economy!");
	    		    return DRCEconomyManagerEconomySystemType.VAULT;
	            } else
	    ...
	    return DRCEconomyManagerEconomySystemType.NONE;
	}
